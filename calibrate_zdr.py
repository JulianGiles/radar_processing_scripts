...
#%% Load and attach temperature data (for ML estimation, or in case temperature comes from other source different than ERA5)
...
#%% Calculate ZDR offset method 1
    if calib_type==1:
        ...
        phidp_offset = utils.phidp_offset_detection(data, phidp="UPHIDP")
