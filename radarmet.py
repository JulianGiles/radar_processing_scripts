...
visdict14 = dict(ZH=dict(ticks=np.arange(-10,55,5),
                ...
                DBZH=dict(ticks=np.arange(-10,55,5),
                         contours=[0, 5, 10, 15, 20, 25, 30, 35],
                          cmap="miub2",
                         name=r'Horizontal Reflectivity (Atten. corrected) (dBz)',
                         short='$\mathrm{\mathsf{Z_{H}}}$'),
                DBZH_AC=dict(ticks=np.arange(-10,55,5),
                         contours=[0, 5, 10, 15, 20, 25, 30, 35],
                          cmap="miub2",
                         name=r'Horizontal Reflectivity (dBz)',
                         short='$\mathrm{\mathsf{Z_{H}}}$'),
                ...
                DBTH=dict(ticks=np.arange(-10,55,5),
                         ...
                         name=r'Total Reflectivity (dBz)',
                         short='$\mathrm{\mathsf{Z_{H}}}$'),
                DBTH_OC=dict(ticks=np.arange(-10,55,5),
                         contours=[0, 5, 10, 15, 20, 25, 30, 35],
                          cmap="miub2",
                         name=r'Total Reflectivity (dBz)',
                         short='$\mathrm{\mathsf{Z_{H}}}$'),
                 ...
                 ZDR_EC=dict(ticks=np.array([-1., -0.1, 0, 0.1, 0.2, 0.3, 0.4, .5, 0.6, 0.8, 1.0, 2., 3.0]),
                          contours=np.array([-1, -0.3, 0]),
                          cmap="miub2",
                          name=r'Differential Reflectivity (dB)',
                          short='$\mathrm{\mathsf{Z_{DR}}}$'),
                 ZDR_OC=dict(ticks=np.array([-1., -0.1, 0, 0.1, 0.2, 0.3, 0.4, .5, 0.6, 0.8, 1.0, 2., 3.0]),
                          ...
                          short='$\mathrm{\mathsf{Z_{DR}}}$'),
                 UZDR_OC=dict(ticks=np.array([-1., -0.1, 0, 0.1, 0.2, 0.3, 0.4, .5, 0.6, 0.8, 1.0, 2., 3.0]),
                          contours=np.array([-1, -0.3, 0]),
                          cmap="miub2",
                          name=r'Differential Reflectivity (offset corrected) (dB)',
                          short='$\mathrm{\mathsf{Z_{DR}}}$'),
                 ZDR_EC_OC=dict(ticks=np.array([-1., -0.1, 0, 0.1, 0.2, 0.3, 0.4, .5, 0.6, 0.8, 1.0, 2., 3.0]),
                          contours=np.array([-1, -0.3, 0]),
                          cmap="miub2",
                          name=r'Differential Reflectivity (offset corrected) (dB)',
                          short='$\mathrm{\mathsf{Z_{DR}}}$'),
                 ZDR_EC_OC_WRC=dict(ticks=np.array([-1., -0.1, 0, 0.1, 0.2, 0.3, 0.4, .5, 0.6, 0.8, 1.0, 2., 3.0]),
                          contours=np.array([-1, -0.3, 0]),
                          cmap="miub2",
                          name=r'Differential Reflectivity (offset corrected) (dB)',
                          short='$\mathrm{\mathsf{Z_{DR}}}$'),
                 ZDR_EC_OC_AC=dict(ticks=np.array([-1., -0.1, 0, 0.1, 0.2, 0.3, 0.4, .5, 0.6, 0.8, 1.0, 2., 3.0]),
                          contours=np.array([-1, -0.3, 0]),
                          cmap="miub2",
                          name=r'Differential Reflectivity (offset+attenuation corrected) (dB)',
                          short='$\mathrm{\mathsf{Z_{DR}}}$'),
                 ZDR_EC_OC_WRC_AC=dict(ticks=np.array([-1., -0.1, 0, 0.1, 0.2, 0.3, 0.4, .5, 0.6, 0.8, 1.0, 2., 3.0]),
                          contours=np.array([-1, -0.3, 0]),
                          cmap="miub2",
                          name=r'Differential Reflectivity (offset+attenuation corrected) (dB)',
                          short='$\mathrm{\mathsf{Z_{DR}}}$'),
                 ...
                 ZDR_AC=dict(ticks=np.array([-1., -0.1, 0, 0.1, 0.2, 0.3, 0.4, .5, 0.6, 0.8, 1.0, 2., 3.0]),
                          ...
                          short='$\mathrm{\mathsf{Z_{DR}}}$'),
                 ZDR_EC_AC=dict(ticks=np.array([-1., -0.1, 0, 0.1, 0.2, 0.3, 0.4, .5, 0.6, 0.8, 1.0, 2., 3.0]),
                          contours=np.array([-1, -0.3, 0]),
                          cmap="miub2",
                          name=r'Differential Reflectivity (attenuation corrected) (dB)',
                          short='$\mathrm{\mathsf{Z_{DR}}}$'),
                 ...
                 KDP_ML_corrected=dict(ticks=np.array([-0.5, -0.1, 0.0, 0.05, 0.1, 0.2, 0.3, 0.4, 0.6, 0.8, 1.0, 2.0, 3.0]),
                          ...
                          name=r'Specific Differental Phase (°/km)',
                          short='$\mathrm{\mathsf{K_{DP}}}$'),
                 KDP_ML_corrected_EC=dict(ticks=np.array([-0.5, -0.1, 0.0, 0.05, 0.1, 0.2, 0.3, 0.4, 0.6, 0.8, 1.0, 2.0, 3.0]),
                          cmap="miub2",
                          name=r'Specific Differental Phase (°/km)',
                          short='$\mathrm{\mathsf{K_{DP}}}$'),
                 ...
                 PHIDP_OC_MASKED=dict(ticks=np.array([0,5,10,15,20,25,30,40,50,60,70,80,90]),
                          ...
                          name=r'Differental Phase (°)',
                          short='$\mathrm{\mathsf{\Phi_{DP}}}$'),
                 UPHIDP_UF=dict(ticks=np.array([0,5,10,15,20,25,30,40,50,60,70,80,90]),
                          cmap="miub2",
                          name=r'Differental Phase (°)',
                          short='$\mathrm{\mathsf{\Phi_{DP}}}$'),
                 UPHIDP_UF_OC=dict(ticks=np.array([0,5,10,15,20,25,30,40,50,60,70,80,90]),
                          cmap="miub2",
                          name=r'Differental Phase (°)',
                          short='$\mathrm{\mathsf{\Phi_{DP}}}$'),
                 UPHIDP_UF_OC_SMOOTH=dict(ticks=np.array([0,5,10,15,20,25,30,40,50,60,70,80,90]),
                          cmap="miub2",
                          name=r'Differental Phase (°)',
                          short='$\mathrm{\mathsf{\Phi_{DP}}}$'),
                 UPHIDP_UF_OC_MASKED=dict(ticks=np.array([0,5,10,15,20,25,30,40,50,60,70,80,90]),
                          cmap="miub2",
                          name=r'Differental Phase (°)',
                          short='$\mathrm{\mathsf{\Phi_{DP}}}$'),
                 PHIDP_UF_OC=dict(ticks=np.array([0,5,10,15,20,25,30,40,50,60,70,80,90]),
                          cmap="miub2",
                          name=r'Differental Phase (°)',
                          short='$\mathrm{\mathsf{\Phi_{DP}}}$'),
                 PHIDP_UF_OC_SMOOTH=dict(ticks=np.array([0,5,10,15,20,25,30,40,50,60,70,80,90]),
                          cmap="miub2",
                          name=r'Differental Phase (°)',
                          short='$\mathrm{\mathsf{\Phi_{DP}}}$'),
                 PHIDP_UF_OC_MASKED=dict(ticks=np.array([0,5,10,15,20,25,30,40,50,60,70,80,90]),
                          cmap="miub2",
                          name=r'Differental Phase (°)',
                          short='$\mathrm{\mathsf{\Phi_{DP}}}$'),
                 ...
                 riming_DR=dict(ticks=np.array([0.00001, 1]),
                          cmap='binary2',
                          name=r'Riming estimation based on DR',
                          short='$\mathrm{\mathsf{riming_{DR}}}$'),
                 riming_UDR=dict(ticks=np.array([0.00001, 1]),
                          cmap='cividis',
                          name=r'Riming estimation based on UDR',
                          short='$\mathrm{\mathsf{riming_{UDR}}}$'),
                 riming_ZDR_OC_DBZH=dict(ticks=np.array([0.00001, 1]),
                          cmap='cividis',
                          name=r'Riming estimation based on ZDR_OC and DBZH',
                          short='$\mathrm{\mathsf{riming_{ZDR_OC, ZH}}}$'),
                 riming_ZDR_DBZH=dict(ticks=np.array([0.00001, 1]),
                          cmap='cividis',
                          name=r'Riming estimation based on ZDR and DBZH',
                          short='$\mathrm{\mathsf{riming_{ZDR, ZH}}}$'),
                 WC=dict(ticks=np.array(np.linspace(0,0.4, 21)),
